...
<body>
    ...
    <div class="section">
        <div class="container">
            <h1>Profil <p class="active"><?php echo $d->username ?></p>
            </h1>
            <div class="box">
                <form action="" method="POST">
                    ...
                    <input type="text" name="user_telp" placeholder="081234567890" class="input-control <?php echo empty($d->user_telp) ? 'warning' : ''; ?>" required value="<?php echo $d->user_telp ?>">

                    <input type="text" name="user_addres" placeholder="Jl. Merdeka No. 10, Jakarta" class="input-control <?php echo empty($d->user_address) ? 'warning' : ''; ?>" required value="<?php echo $d->user_address ?>">
